...
const ImageBlob = () => {
  return (
    <div className='sm:hidden w-full h-auto flex items-center justify-center mb-10'>
      <svg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'>
        <defs>
          <clipPath id='image-blob' clipPathUnits='userSpaceOnUse'>
            <path
              fill='#22C55E'
        ...
        <image
          href='/assets/img/hero-image.png'
          y='30'
          x='10'
          width='200'
          height='160'
